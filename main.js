...
// AIzaSyBhrZTCU1qdakvGdS2gLY0PCARvTfUjIts
const perguntarIA = async (question, game, apiKey) => {
    const model = "gemini-2.0-flash";
    const geminiURL = `https://generativelanguage.googleapis.com/v1beta/models/${model}:generateContent?key=${apiKey}`;
    const pergunta = `
    ## Especialidade
    Você é um especialista assistente em ${game}.
    ...
    ## Resposta
    Economize na resposta, seja direto e responda de forma objetiva. Não ultrapasse dos 600 caracteres Responda em markdown.
